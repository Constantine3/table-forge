...
describe('parseDshArgs', () => {
  it('routes profile boots and the product aliases, handing the rest to the app', () => {
    ...
    expect(parse(['game'])).toEqual({ mode: 'profile', profile: 'game', patches: [], args: [] })
    expect(parse(['game', '--patch', 'game.yml']))
      .toEqual({ mode: 'profile', profile: 'game', patches: ['game.yml'], args: [] })
  })
