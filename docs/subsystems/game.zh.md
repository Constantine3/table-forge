...
游戏子系统运行确定性、事件溯源的对局，其中席位可以由人类或独立配置的 AI Agent 控制。交付产品包括支持人类对 AI 或 AI 对 AI 的剪刀石头布，以及由一名人类与其余 AI 组成或全部由 AI 控制的五人或六人阿瓦隆。
...
阿瓦隆使用私有种子分配梅林、刺客、一名莫德雷德的爪牙，以及五人局的两名或六人局的三名亚瑟的忠臣，再持久化分配结果以保持确定回放。队长公开队伍并选择顺时针或逆时针讨论；指定方向上的相邻席位先发言，所有非队长席位依次发言，队长进行最后一句归票发言。五人或六人的全部发言提交后，每个席位才收到不附带陈述的封存赞成票或否决票；通过后的队员提交封存任务动作。五人局的任务人数依次为 2、3、2、3、3，队伍获得三票即可通过；六人局依次为 2、3、4、3、4，需要四票通过。三次任务失败或连续五支队伍被否决时邪方获胜；三次任务成功后，邪方会先在受限窗口中依次发言，再由刺客选择目标，只有最终裁定后才公开全部身份。
