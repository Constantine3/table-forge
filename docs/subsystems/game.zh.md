...
阿瓦隆在所有支持人数下都使用梅林和刺客，五人局与六人局有一名莫德雷德的爪牙，七人局有两名；五人局有两名亚瑟的忠臣，六人局与七人局有三名。身份由私有种子分配并持久化，以保持确定回放。队长公开队伍并选择顺时针或逆时针讨论；指定方向上的相邻席位先发言，所有非队长席位依次发言，队长进行最后一句归票发言。全部发言提交后，每个席位才收到不附带陈述的封存赞成票或否决票；通过后的队员提交封存任务动作。五人局的任务人数依次为 2、3、2、3、3，六人局为 2、3、4、3、4，七人局为 2、3、3、4、4。五人局队伍获得三票即可通过，六人局与七人局需要四票。除七人局第四次任务需要两张失败票外，其他任务有一张失败票就会失败。三次任务失败或连续五支队伍被否决时邪方获胜；三次任务成功后，邪方会先在受限窗口中依次发言，再由刺客选择目标，只有最终裁定后才公开全部身份。
