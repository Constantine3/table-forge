...
import matchesRemote from '@deepseek-ai/dsh-game-engine/remote'
...
export type {} from '@deepseek-ai/dsh-game-engine/remote'
...
export type {} from '@deepseek-ai/dsh-game'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, matchesRemote,
    ]) {
