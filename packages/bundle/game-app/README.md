...
`dsh-game-app` is the Table Forge product layer. It stacks after `dsh-web-app`, mounting the game registries, SQLite match persistence, event-sourced engine, rock-paper-scissors and five- through eight-player Avalon definitions, Agent controller, generic browser root, and both game surfaces.
