...
`dsh-game-app` 是 Table Forge 产品层。它叠加在 `dsh-web-app` 之后，挂载游戏注册表、SQLite 对局持久化、事件溯源引擎、剪刀石头布与五人或六人阿瓦隆定义、Agent 控制器、通用浏览器根界面以及两种游戏界面。
...
- 阿瓦隆支持一名人类与其余 AI 组成的圆桌，也支持全 AI 圆桌；交付产品不提供匹配或多浏览器观战与牌桌协作。
