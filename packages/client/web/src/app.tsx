 ...
 * set is active. Product profiles contribute the built-in `root` slot; the
 * shell owns the program's one context-level render call.
 */
...
/** Assembly inputs: the active app-shell plugin context with slots and sessions available. */
