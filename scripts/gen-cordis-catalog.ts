...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  e2b: 'subprocess.md',
  fs: 'filesystem.md',
  gameControllers: 'game.md',
  gameDefinitions: 'game.md',
  gamePersistence: 'game.md',
  goals: 'goal.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CreateMatchRequest: 'game.md',
  GameControllerProvider: 'game.md',
  GameControllerRequest: 'game.md',
  GameDefinition: 'game.md',
  MatchId: 'game.md',
  MatchEvent: 'game.md',
  MatchRecord: 'game.md',
  MatchView: 'game.md',
  SeatControllerSpec: 'game.md',
  SeatId: 'game.md',
  SubmitActionRequest: 'game.md',
